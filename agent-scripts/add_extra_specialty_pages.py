...
extra_pages = [
    # Orthopaedics
    {"slug": "orthopedic-doctor-nirman-nagar-jaipur", "service": "Orthopedic Doctor", "location": "Nirman Nagar, Jaipur", "doc": "Dr Chirag Jain", "dept": "Orthopaedics and Joint Replacement", "type": "Physician"},
    {"slug": "knee-replacement-surgeon-kings-road-jaipur", "service": "Knee Replacement Surgeon", "location": "Kings Road, Jaipur", "doc": "Dr Chirag Jain", "dept": "Orthopaedics and Joint Replacement", "type": "Physician"},
    
    # Urology
    {"slug": "urologist-nirman-nagar-jaipur", "service": "Urologist", "location": "Nirman Nagar, Jaipur", "doc": "Dr R N Daga", "dept": "Urology and Andrology", "type": "Physician"},
    
    # Neurosurgery
    {"slug": "neurosurgeon-nirman-nagar-jaipur", "service": "Neurosurgeon", "location": "Nirman Nagar, Jaipur", "doc": "Dr Pavan Jain", "dept": "Neurosurgery", "type": "Physician"},
    
    # ENT
    {"slug": "ent-specialist-kings-road-jaipur", "service": "ENT Specialist", "location": "Kings Road, Jaipur", "doc": "Dr N S Rathore", "dept": "ENT", "type": "Physician"},
    
    # General Medicine
    {"slug": "general-physician-nirman-nagar-jaipur", "service": "General Physician", "location": "Nirman Nagar, Jaipur", "doc": "Dr Vishnu Gupta", "dept": "General Medicine", "type": "Physician"},
    
    # Pathology
    {"slug": "pathology-lab-nirman-nagar-jaipur", "service": "Pathology Lab", "location": "Nirman Nagar, Jaipur", "doc": "Dr Vinita Jain", "dept": "Pathology and Diagnostics", "type": "Hospital"},
]
...
print("Extra local SEO pages generated successfully.")
