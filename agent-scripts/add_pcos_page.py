...
def create_page(slug, service, location, is_hi=False):
    ...
    source = f"site/hi/treatments/gynaecologist-nirman-nagar-jaipur.html" if is_hi else f"site/treatments/gynaecologist-nirman-nagar-jaipur.html"
    ...
    old_h1 = "Gynaecologist in Nirman Nagar, Jaipur" if not is_hi else "निर्माण नगर, जयपुर में Gynaecologist"
